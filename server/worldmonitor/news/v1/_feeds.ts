...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  full: {
    ...
    europe: [
      ...
      { name: 'NRC', url: 'https://www.nrc.nl/rss/', lang: 'nl' },
      { name: 'De Telegraaf', url: 'https://news.google.com/rss/search?q=site:telegraaf.nl+when:1d&hl=nl&gl=NL&ceid=NL:nl', lang: 'nl' },
    ...
    latam: [
      ...
      { name: 'Latin America', url: 'https://news.google.com/rss/search?q=(Brazil+OR+Mexico+OR+Argentina+OR+Venezuela+OR+Colombia+OR+Haiti)+when:2d&hl=en-US&gl=US&ceid=US:en' },
      ...
      { name: 'O Globo', url: 'https://news.google.com/rss/search?q=site:oglobo.globo.com+when:1d&hl=pt-BR&gl=BR&ceid=BR:pt-419', lang: 'pt' },
      { name: 'Brasil Paralelo', url: 'https://www.brasilparalelo.com.br/noticias/rss.xml', lang: 'pt' },
...
// Central Asia (#5953) — Russia rear area, China BRI, sanctions leakage
      ...
      { name: 'Thai PBS', url: 'https://news.google.com/rss/search?q=Thai+PBS+World+news&hl=en&gl=US&ceid=US:en', lang: 'th' },
      { name: 'Tuoi Tre News', url: 'https://news.tuoitre.vn/rss', lang: 'vi' },
    ...
    india: [
      ...
      { name: 'ThePrint Defence', url: 'https://theprint.in/category/defence/feed/' },
      ...
      { name: 'Reserve Bank of India', url: 'https://www.rbi.org.in/pressreleases_rss.xml' },
      { name: 'Business Standard', url: 'https://www.business-standard.com/rss/latest.rss' },
      { name: 'Lokmat', url: 'https://www.lokmat.com/rss/mumbai.xml', lang: 'mr' },
      { name: 'Oneindia Telugu', url: 'https://telugu.oneindia.com/rss/telugu-news-fb.xml', lang: 'te' },
      { name: 'Oneindia Malayalam', url: 'https://malayalam.oneindia.com/rss/malayalam-news-fb.xml', lang: 'ml' },
      { name: 'Oneindia Marathi', url: 'https://marathi.oneindia.com/rss/marathi-news-fb.xml', lang: 'mr' },
      { name: 'Organiser', url: 'https://organiser.org/feed/' },
      { name: 'India TV News', url: 'https://www.indiatvnews.com/rssnews/topstory.xml' },
      { name: 'Siasat Daily', url: 'https://www.siasat.com/feed/' },
      { name: 'Greater Kashmir', url: 'https://www.greaterkashmir.com/feed/' },
      { name: 'Kashmir Reader', url: 'https://kashmirreader.com/feed' },
      { name: 'Sentinel Assam', url: 'https://sentinelassam.com/feed' },
      { name: 'Millennium Post', url: 'https://www.millenniumpost.in/feed' },
      { name: 'The Federal', url: 'https://www.thefederal.com/feed' },
      { name: 'The Better India', url: 'https://www.thebetterindia.com/feed/' },
      { name: 'Business Today', url: 'https://www.businesstoday.in/rssfeeds/?id=225346' },
      { name: 'Rising Kashmir', url: 'https://risingkashmir.com/feed' },
      { name: 'Kashmir Life', url: 'https://kashmirlife.net/feed/' },
      { name: 'Vikatan', url: 'https://www.vikatan.com/feed', lang: 'ta' },
      { name: 'Sandesh', url: 'https://sandesh.com/rss/gujarat.xml', lang: 'gu' },
      { name: 'The Shillong Times', url: 'https://theshillongtimes.com/feed/' },
      { name: 'OdishaTV', url: 'https://odishatv.in/feed' },
      { name: 'OrissaPost', url: 'https://www.orissapost.com/feed/' },
      { name: 'Prameya News', url: 'https://www.prameyanews.com/feed/', lang: 'or' },
      { name: 'Prajavani', url: 'https://www.prajavani.net/feed', lang: 'kn' },
      { name: 'Deccan Herald', url: 'https://www.deccanherald.com/feed' },
      { name: 'Bharat Shakti', url: 'https://www.bharatshakti.in/feed/' },
      { name: 'IDRW', url: 'https://idrw.org/feed/' },
      { name: 'The Assam Tribune', url: 'https://www.assamtribune.com/feed' },
      { name: 'NorthEast Now', url: 'https://nenow.in/feed' },
      { name: 'Autocar India', url: 'https://www.autocarindia.com/rss/all' },
      { name: 'Telangana Today', url: 'https://www.telanganatoday.com/feed' },
      { name: 'Bollywood Hungama', url: 'https://www.bollywoodhungama.com/rss/news.xml' },
      { name: 'NewsClick', url: 'https://www.newsclick.in/rss.xml' },
      { name: 'ESPNcricinfo', url: 'https://www.cricinfo.com/rss/content/story/feeds/6.xml' },
      { name: 'Prabhat Khabar', url: 'https://www.prabhatkhabar.com/feed', lang: 'hi' },
      { name: 'Pinkvilla', url: 'https://www.pinkvilla.com/rss.xml' },
      { name: 'Bar and Bench', url: 'https://www.barandbench.com/feed' },
      { name: 'Navjivan', url: 'https://www.navjivanindia.com/feed', lang: 'hi' },
      { name: 'Janta Se Rishta', url: 'https://www.jantaserishta.com/feed', lang: 'hi' },
    ],
  },
...
export const INTEL_SOURCES: ServerFeed[] = [
  ...
  { name: 'Chatham House', url: 'https://news.google.com/rss/search?q=site:chathamhouse.org+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'ECFR', url: 'https://news.google.com/rss/search?q=site:ecfr.eu+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'Middle East Institute', url: 'https://news.google.com/rss/search?q=site:mei.edu+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'FAS', url: 'https://news.google.com/rss/search?q=site:fas.org+nuclear+weapons+security&hl=en&gl=US&ceid=US:en' },
  { name: 'NTI', url: 'https://news.google.com/rss/search?q=site:nti.org+when:30d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'Wilson Center', url: 'https://news.google.com/rss/search?q=site:wilsoncenter.org+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'GMF', url: 'https://news.google.com/rss/search?q=site:gmfus.org+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'Stimson Center', url: 'https://www.stimson.org/feed/' },
  { name: 'CNAS', url: 'https://news.google.com/rss/search?q=site:cnas.org+when:7d&hl=en-US&gl=US&ceid=US:en' },
  { name: 'Lowy Institute', url: 'https://news.google.com/rss/search?q=site:lowyinstitute.org+when:7d&hl=en-US&gl=US&ceid=US:en' },
  ...
  { name: 'EU ISS', url: 'https://news.google.com/rss/search?q=site:iss.europa.eu+when:7d&hl=en-US&gl=US&ceid=US:en' },
];
