...
async function handler(req) {
  ...
  const explicitWorldMonitorKey = isSessionTokenShape(headerWorldMonitorKey) ? "" : headerWorldMonitorKey;
  const worldMonitorKey = explicitWorldMonitorKey || getCookie(req, "wm-pro-key") || getCookie(req, "wm-widget-key") || headerWorldMonitorKey;
