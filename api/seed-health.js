...
var SEED_DOMAINS = {
  ...
  "military:bases": { key: "seed-meta:military:bases", intervalMin: 43200, activationKey: "military:bases:active", minRecordCount: 1e5 },
  ...
  "economic:boc-valet": { key: "seed-meta:economic:boc-valet", intervalMin: 1440, minRecordCount: 19 },
  // daily cron (seed-bundle-macro); api/health.js maxStaleMin 4320 = 3x. minRecordCount = 15 FX + policy + 3 yields.
  "economic:statcan-wds": { key: "seed-meta:economic:statcan-wds", intervalMin: 1440, minRecordCount: 2 },
  // daily cron; floor is CPI YoY + LFS unemployment. Empty change-list is valid quiet.
  ...
  "demographics:capability": { key: "seed-meta:demographics:capability", intervalMin: 18e3, minRecordCount: 150 },
  // static-ref every 20d; 25d /api/health budget expressed as intervalMin * 2.
  ...
  "transit:viarail-live": { key: "seed-meta:transit:viarail-live", intervalMin: 15 }
  // 15min cron; intervalMin*3 = health.js maxStaleMin 45
};
