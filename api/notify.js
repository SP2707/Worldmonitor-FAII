...
var NOTIFY_WRITE_RATE_LIMIT = 30;
var NOTIFY_WRITE_RATE_SCOPE = "notify-write";
var NOTIFY_WRITE_RATE_WINDOW = "60 s";
var NOTIFY_MAX_PAYLOAD_BYTES = 16 * 1024;
function createDefaultNotifyDeps() {
  return {
    validateBearerToken,
...
var notifyDeps = createDefaultNotifyDeps();
function __setNotifyDepsForTests(overrides) {
  notifyDeps = overrides ? { ...createDefaultNotifyDeps(), ...overrides } : createDefaultNotifyDeps();
}
function notifyTooManyRequestsResponse(scoped, cors) {
